        ...
        <div className="flex min-h-screen flex-col items-center justify-center bg-background p-4">
            <div className="w-full max-w-sm text-center">
                ...
                <Card className="bg-card p-8 rounded-lg shadow-lg border text-left">
                     <h2 className="text-2xl font-semibold mb-2 text-center">Crear una Cuenta</h2>
                     <p className="text-muted-foreground mb-6 text-center">Únete para empezar a gestionar préstamos.</p>
                     <Form {...form}>
